...
CREATE INDEX IF NOT EXISTS my9_share_subject_slot_v1_kind_created_idx
ON my9_share_subject_slot_v1 (kind, created_at DESC);

CREATE INDEX IF NOT EXISTS my9_share_subject_slot_v1_kind_day_subject_idx
ON my9_share_subject_slot_v1 (kind, day_key, subject_id);

CREATE INDEX IF NOT EXISTS my9_share_subject_slot_v1_kind_hour_subject_idx
ON my9_share_subject_slot_v1 (kind, hour_bucket, subject_id);
