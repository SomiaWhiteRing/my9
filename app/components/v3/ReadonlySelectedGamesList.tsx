...
export function ReadonlySelectedGamesList({
  ...
  return (
    <SelectedGamesSection subjectLabel={subjectLabel} enableResonance>
            ...
            >
              <div className="flex min-w-0 items-start gap-3 sm:gap-4">
                ...
                <div className="-mt-0.5 flex flex-col items-center gap-1 self-start sm:-mt-1">
                  ...
                  {selectionStats?.counts[String(game.id)] !== 0 ? <RelatedSelectionsButton /> : null}
                </div>
              </div>
            </SelectedGameCard>
          );
      ...
      <ShareSelectionStatsTimestamp stats={selectionStats} />
